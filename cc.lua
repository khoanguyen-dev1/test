...
L2.BackgroundTransparency = 0.1
L2.BorderSizePixel = 0
L2.Position = UDim2.new(0.1208, 0, 0.0953, 0)
L2.Size = UDim2.new(0, 55, 0, 55)
L2.Font = Enum.Font.SourceSans
L2.Text = ""
L2.TextColor3 = Color3.fromRGB(153, 51, 255)
L2.TextSize = 20.000
L2.Draggable = true
sound.Parent = L2
...
local L7 = Instance.new("UICorner")
local L8 = Instance.new("ImageLabel")
...
L8.BackgroundTransparency = 1.000
L8.BorderSizePixel = 0
L8.Position = UDim2.new(0.1, 0, 0.1, 0) 
L8.Size = UDim2.new(0, 45, 0, 45)
L8.Image = ""
L5.Name = "CustomButton2"
L5.Parent = L1
L5.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
L5.BackgroundTransparency = 0.1
L5.BorderSizePixel = 0
L5.Position = UDim2.new(0, 10, 0.3, 0) 
L5.Size = UDim2.new(0, 55, 0, 45)
...
L5.Draggable = false
sound2.Parent = L5
sound2.SoundId = "rbxassetid://130785805"
...
-- Hàm kiểm tra nhiệm vụ dựa trên cấp độ người chơi
local function CheckQuest()
    ...
    if _G.AutoFarm and (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", CFrameQuest.Position)
    end
...
Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Bring Mob", Default = true})
Toggle:OnChanged(
function(Mag)
    _G.BringMonster = Mag
    saveSettings()
...
Toggle = Tabs.Main:AddToggle("MyToggle", {Title = "Fast Attack V2", Description = "Better than old attack recommended", Default = true })
Toggle:OnChanged(function(Value)
Fast_Attack = Value
saveSettings()
end) 
...
local lvParagraph
lvParagraph = Tabs.Main:AddParagraph({
Title = "Your Status",
Content = ""
})
spawn(function()
