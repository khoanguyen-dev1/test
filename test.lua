...
local Toggle = Tabs.Setting:AddToggle("Walk Water", { Title = "Walk Water", Default = true })
Toggle:OnChanged(function(Value)
	_G.NuocLon = Value
end)
...
local Toggle = Tabs.Setting:AddToggle("Walk Water", { Title = "Auto Rejoin", Description = "Rejoin When Kick", Default = false })
Toggle:OnChanged(function(Value)
	_G.Rejoin = Value
end)                          
...
local Toggle = Tabs.Setting:AddToggle("RemoveConMe", { Title = "Remove Damege", Description = "Xoá Damege", Default = false })
...
local Toggle = Tabs.Setting:AddToggle("RemoveConMe", { Title = "Remove Notification", Description = "Xoá Thông Báo", Default = false })
Toggle:OnChanged(function(UwUOnTop)
...
-----Shop Melee-----
local Dropdown = Tabs.Setting:AddDropdown("DropdownMelee", {
	Title = "Mua Melee",
